...
ORG_SEED = [
    ...
    ("Halton Region",
     ["Regional Municipality of Halton", "The Regional Municipality of Halton",
      "Region of Halton"],
     ["municipality"], "municipal", "ON"),
    # Tier 3 buyers (Phase 1 coverage program, validated 2026-07-27):
    ("City of St. Catharines",
     ["St. Catharines", "The Corporation of the City of St. Catharines"],
     ["municipality"], "municipal", "ON"),
    ("City of Thunder Bay",
     ["Thunder Bay", "The Corporation of the City of Thunder Bay"],
     ["municipality"], "municipal", "ON"),
    ("Town of Whitby",
     ["Whitby", "The Corporation of the Town of Whitby"],
     ["municipality"], "municipal", "ON"),
    ("City of Burlington",
     ["Burlington", "The Corporation of the City of Burlington"],
     ["municipality"], "municipal", "ON"),
    ...
    # Service Boards", so both spellings ride along as aliases. Parked
    # boards' orgs deliberately wait for their unparking PR.
    ("York Regional Police Services Board",
     ["YRPSB", "York Region Police Services Board",
      "York Regional Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("Durham Regional Police Services Board",
     ["DRPSB", "Durham Region Police Services Board",
      "Durham Regional Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("Halton Police Board",
     ["Halton Regional Police Services Board", "Halton Police Services Board",
      "Halton Regional Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("Waterloo Regional Police Services Board",
     ["WRPSB", "Waterloo Regional Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("Greater Sudbury Police Services Board",
     ["GSPSB", "Greater Sudbury Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("London Police Service Board",
     ["LPSB", "London Police Service Board"],
     ["police_board"], "municipal", "ON"),
    ("Durham Regional Police Service",
     ["DRPS", "Durham Regional Police"],
     ["police_service"], "municipal", "ON"),
    ("Halton Regional Police Service",
     ["HRPS", "Halton Police", "Halton Regional Police"],
     ["police_service"], "municipal", "ON"),
    ("Waterloo Regional Police Service",
     ["WRPS", "Waterloo Regional Police"],
     ["police_service"], "municipal", "ON"),
    ("Greater Sudbury Police Service",
     ["GSPS", "Greater Sudbury Police"],
     ["police_service"], "municipal", "ON"),
