...
def probe_static(session: requests.Session) -> dict | None:
    ...
    try:
        ...
        # Heuristic: if <main> or body content is very short, probably JS-shell
...
def main():
    ...
    if static:
        ...
        # If body text is very short it's a JS-shell -- run Playwright
